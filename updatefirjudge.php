...
<head>
	...
	<link rel="stylesheet" type="text/css" href="updatefirjudge.css">
		...
		<div class = "main-panel">
			...
			<?php
					...
					while($row = mysqli_fetch_row($result))
					{
						...
						echo "<tr>";
						echo "<td>$indexno</td>";
						echo "<td> <a href='http://localhost/DBMS-Project/judgechangestatus.php?id=$firno'> $row[0]</a></td>"; /// change it
						echo "<td>$row[1]</td>";
						echo "<td>$row[2]</td>";
						echo "</tr>";
						$indexno++;
