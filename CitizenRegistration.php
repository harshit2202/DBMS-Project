...
<head>
	...
	<link rel="stylesheet" type="text/css" href="CitizenRegistration.css">
...
<body>
		...
		<div class="maine">
			...
			<div class="main-side">
				<br>
				<p style="font-size: 40px;  text-align: center;">Citizen Registration</p>
				<br><br>
					<form method="post">
					  <div class="form-row">
					    <div class="form-group col-md-6">
					      <label for="name">Name</label>
					      <input required type="text" name="name" class="form-control" id="name" placeholder="Full name" required="PLease enter "
                              <?php echo isset($_POST['name'])?'value="'.htmlspecialchars($_POST['name']).'"':''; ?> >
					    </div>
					    <div class="form-group col-md-6">
					      <label for="email">Email-ID (Verification mail will be sent.)</label>
					      <input required type="email" name="email" class="form-control" id="email" placeholder="proness123"
