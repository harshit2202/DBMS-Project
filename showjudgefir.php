...
<head>
	...
	<link rel="stylesheet" type="text/css" href="showjudgefir.css">
...
<body>
	<div class = "global">
		...
		<div class = "main-panel">
			<p style="text-align: center; font-size: 20px;">Click on FIR no. to show its detail.</p>
			...
			<?php
					...
					while($row = mysqli_fetch_row($result))
					{
						...
						echo "<tr>";
						echo "<td>$indexno</td>";
						echo "<td> <a href='http://localhost/DBMS-Project/firprogressjudge.php?id=$firno'> $row[0]</a></td>";
						echo "<td>$row[1]</td>";
						echo "<td>$row[2]</td>";
						echo "</tr>";
						$indexno++;
