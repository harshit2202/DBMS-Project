...
<?php 
	...
	if(isset($_REQUEST["register"]))
	{
		...
		$var1 = $_POST["username"];
		$sql = "SELECT username FROM coptable WHERE username='$var1'";

		$result1 = $conn->query($sql);

		$var2 = $_POST["email"];
		$sql2 = "SELECT email FROM coptable WHERE email='$var2'";
...
<body>
		...
		<div class="maine">
			...
			<div class="main-side">
				<br>
				<p style="font-size: 40px;  text-align: center;">COP Registration</p>
				<br><br>
					<form method="post">
						<div class="form-group">
						    <label for="inputAddress2">COP Unique Registration Number</label>
						    <input type="text" name="police-id" class="form-control" id="inputAddress2" placeholder="Provided by Indian police authorization">
					  	</div>
					  <div class="form-row">
